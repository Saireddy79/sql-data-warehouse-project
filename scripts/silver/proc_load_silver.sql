...
BEGIN
	...
	*,
	...
	SELECT DISTINCT
		...
		CAST(LEAD(prd_start_dt) OVER(PARTITION BY prd_key ORDER BY prd_start_dt)-1 AS DATE) prd_end_test --calculate end date as one day before the next start date
